...
Behavior:
    This test case generates a 404 HTTP does not exists status response. 
Tests:
    This server tests whether the client can correctly handle status code 404.
...
def get_test_response():
    ...
    response_status_line = 'HTTP/1.1 404 OK'
    response_headers = [
