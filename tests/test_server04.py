...
Behavior:
    This test case generates a 304 HTTP not modified status response. 
Tests:
    This server tests whether the client can correctly handle status code 304.
...
def get_test_response():
    ...
    response_status_line = 'HTTP/1.1 304 OK'
    response_headers = [
