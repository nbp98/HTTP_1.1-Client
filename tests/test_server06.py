...
Behavior:
    This test case generates a 301 HTTP moved permanently from disk cache status response. 
Tests:
    This server tests whether the client can correctly handle status code 301.
...
def get_test_response():
    ...
    response_status_line = 'HTTP/1.1 301 OK'
    response_headers = [
